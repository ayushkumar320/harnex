...
from autoharness.runtime import redact_runtime_payload

SANDBOX_SCHEMA_VERSION = "1.0"
DEFAULT_SANDBOX_IMAGE = "autoharness-sandbox:dev"
CONTAINER_SOURCE = "/workspace/source"
CONTAINER_OUTPUT = "/workspace/output"
CONTAINER_TMP = "/workspace/tmp"
MAX_CAPTURE_CHARS = 16_384
ALLOWED_ENV_NAMES = frozenset({"AUTOHARNESS_RUN_ID", "PYTHONHASHSEED", "TZ"})
...
def temporary_sandbox_dirs(prefix: str = "autoharness-sandbox-") -> tuple[Path, Path]:
