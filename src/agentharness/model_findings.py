...
from agentharness.retrieval_models import EvidenceBundle, ExternalEvidence, RetrievedEvidence
            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "You propose AgentHarness finding candidates as compact JSON only. "
